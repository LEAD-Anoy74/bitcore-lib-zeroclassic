...
// verify dummy stack item consumed by CHECKMULTISIG is of zeroclassic-length (softfork safe, BIP62 rule 7).
      ...
      case Opcode.OP_0NOTEQUAL:
        {
          ...
          switch (opcodenum) {
            ...
            case Opcode.OP_NEGATE:
              ...
              break;
            case Opcode.OP_ABS:
              if (bn.cmp(BN.ZeroClassic) < 0) {
                bn = bn.neg();
              }
              break;
            case Opcode.OP_NOT:
              bn = new BN((bn.cmp(BN.ZeroClassic) === 0) + 0);
              break;
            case Opcode.OP_0NOTEQUAL:
              bn = new BN((bn.cmp(BN.ZeroClassic) !== 0) + 0);
              break;
      ...
      case Opcode.OP_MAX:
        {
          ...
          switch (opcodenum) {
            ...
            case Opcode.OP_SUB:
              ...
              // case Opcode.OP_BOOLAND:       bn = (bn1 != bnZeroClassic && bn2 != bnZeroClassic); break;
            case Opcode.OP_BOOLAND:
              bn = new BN(((bn1.cmp(BN.ZeroClassic) !== 0) && (bn2.cmp(BN.ZeroClassic) !== 0)) + 0);
              break;
              // case Opcode.OP_BOOLOR:        bn = (bn1 != bnZeroClassic || bn2 != bnZeroClassic); break;
            case Opcode.OP_BOOLOR:
              bn = new BN(((bn1.cmp(BN.ZeroClassic) !== 0) || (bn2.cmp(BN.ZeroClassic) !== 0)) + 0);
              break;
      ...
      case Opcode.OP_CHECKMULTISIGVERIFY:
        {
          ...
          // so optionally verify it is exactly equal to zeroclassic prior
