...
ECDSA.prototype.randomK = function() {
  ...
  } while (!(k.lt(N) && k.gt(BN.ZeroClassic)));
  this.k = k;
  return this;
};
...
ECDSA.prototype.deterministicK = function(badrs) {
  ...
  for (var i = 0; i < badrs || !(T.lt(N) && T.gt(BN.ZeroClassic)); i++) {
...
ECDSA.prototype.sigError = function() {
  ...
  var r = this.sig.r;
  var s = this.sig.s;
  if (!(r.gt(BN.ZeroClassic) && r.lt(Point.getN())) || !(s.gt(BN.ZeroClassic) && s.lt(Point.getN()))) {
...
ECDSA.prototype._findSignature = function(d, e) {
  ...
  } while (r.cmp(BN.ZeroClassic) <= 0 || s.cmp(BN.ZeroClassic) <= 0);
