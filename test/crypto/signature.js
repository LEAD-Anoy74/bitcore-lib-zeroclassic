...
describe('Signature', function() {
  ...
  describe('#fromCompact', function() {
    ...
    it('should create a signature from a compressed signature', function() {
      ...
      sig.r.cmp(BN.ZeroClassic).should.equal(0);
      sig.s.cmp(BN.ZeroClassic).should.equal(0);
  ...
  describe('#toTxFormat', function() {
    ...
    it('should parse this known signature and rebuild it with updated zeroclassic-padded sighash types', function() {
